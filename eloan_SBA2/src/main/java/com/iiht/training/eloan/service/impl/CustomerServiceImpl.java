...
public class CustomerServiceImpl implements CustomerService {
	...
	public LoanOutputDto applyLoan(Long customerId, LoanDto loanDto) {
		...
		if(user ==null)
			throw new CustomerNotFoundException("No corresponding customer found with the entered id!!");
	...
	public LoanOutputDto getStatus(Long loanAppId) {
		...
		if(Loan ==null)
			throw new LoanNotFoundException("No Loan found with the entered id!!");
	...
	public List<LoanOutputDto> getStatusAll(Long customerId) {
		...
		if(listloans.toString().equals("[]") ) {
			throw new CustomerNotFoundException("No Customer found with the entered id!!");
		}
