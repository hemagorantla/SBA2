...
public class ClerkServiceImpl implements ClerkService {
	...
	public ProcessingDto processLoan(Long clerkId, Long loanAppId, ProcessingDto processingDto) {
		...
		if (loan == null) {
			throw new LoanNotFoundException("Loan Not Found...please recheck");
		}
		Users user = this.usersRepository.findById(clerkId).orElse(null);
		String Role = user.getRole();
		if (user == null || !Role.equals("Clerk"))
			throw new ClerkNotFoundException("Clerk not found...please validate once again!!");
		...
		throw new AlreadyProcessedException("Already Processed Loan!.....check once again");
	}
